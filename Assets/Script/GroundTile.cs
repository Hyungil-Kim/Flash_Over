...
public class GroundTile : MonoBehaviour
{
    ...
    public void CheckParticle()
    {
        ...
        foreach (var elem in visionList)
        {
            ...
            //{
            //    var meshs = elem.GetComponentsInChildren<SkinnedMeshRenderer>();
            //    foreach (var mesh in meshs)
            //    {
            //        mesh.enabled = true;
            //    }
            //    //var material = elem.GetComponent<SkinnedMeshRenderer>().material;
            ...
            //    }
            //    //elem.GetComponentsInChildren<SkinnedMeshRenderer>().enabled = false;
            //}
        }
    }
