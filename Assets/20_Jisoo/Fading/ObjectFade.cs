...
public class ObjectFade : MonoBehaviour
{
    ...
    void Start()
    {
        fadeCheck = GameObject.FindGameObjectWithTag("CreateCharacter").GetComponent<FadeCheck>();
            ...
            if (fadeCheck.parentObjectHit == highestParent)
            {
                if (!faded)
                {
                    ...
                    while (findParent != null)
                    {
                        ...
                        {
                            foreach (Material material in findParent.transform.GetChild(i).GetComponent<MeshRenderer>().materials)
                            {
                                MaterialObjectFade.MakeFade(material);
                                Color newColor = material.color;
                                if (customFade) newColor.a = fadeTo;
